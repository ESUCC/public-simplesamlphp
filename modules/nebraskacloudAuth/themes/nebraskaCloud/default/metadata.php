...
$this->includeAtTemplateBase('includes/header.php'); ?>
    ...
    <p><?php echo("<br />" . $this->t('metadata_xmlurl', array('%METAURL%' => htmlspecialchars($this->data['metaurl'])))); ?></p>
    <div class="input-group"  style="width:100%; position:relative;">
        ...
        <span class="button-container" style="position: absolute; right: 0; top: -3.6em;">
            <button data-clipboard-target="#metadataurl" id="btnurl" class="btn addonright">
    ...
    <div class="metadatabox" style="width:100%; position:relative;">
        <span class="button-container" style="position: absolute; right: 0; top: -3.6em;">
            <button data-clipboard-target="#xmlmetadata" id="btnxml" class="btn topright">
                <img src="/<?php echo $this->data['baseurlpath'].'resources/icons/clipboard.svg'; ?>"
                    alt="Copy to clipboard" />
            </button>
        </span>
    ...
    <p><?php echo "<br /><br />" . ($this->t('metadata_simplesamlformat')); ?></p>
    <div class="metadatabox" style="width:100%; position:relative;">
        <span class="button-container" style="position: absolute; right: 0; top: -3.6em;">
